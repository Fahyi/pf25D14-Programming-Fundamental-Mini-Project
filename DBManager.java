...
public class DBManager {
    ...
    private final String host = "tictactoe-fahyi-f2cb.f.aivencloud.com";
    private final String databaseName = "defaultdb";
    private final String userName = "avnadmin";
    private final String password = "AVNS_EGlGpkJhi4bZqiE2AY9";
    private final String port = "13904";
    ...
    public int createNewGame(String playerName, boolean isHost) {
        String sql = isHost
                ...
                : "INSERT INTO games (player_o) VALUES (?)";
    ...
    public String getOppName(boolean isHost) {
        String sql = isHost
                ? "SELECT player_o FROM games"
                : "SELECT player_x FROM games";
